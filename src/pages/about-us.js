                ...
                <div className="px-4 sm:px-6 sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left lg:flex lg:items-center">
                  <div>
                    ...
                    <p className="mt-3 text-base text-gray-300 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                      We’re here to help with everything from business formation, mergers and acquisitions, property purchases and sales, commercial leases, wills & estates and more. You can trust us to provide proactive advice to prevent problems rather than react to them. It’s the perfect fit for your needs. Let us be there when you need it most!
                    </p>
                  </div>
                </div>
                <div className="mt-16 sm:mt-24 lg:mt-0 lg:col-span-6">
                  <div className="bg-white sm:max-w-md sm:w-full sm:mx-auto sm:rounded-lg sm:overflow-hidden">
                    <div className="px-4 py-8 sm:px-10">
                      <div className="mt-6">
                        <form target="/" method="POST" action="https://formspree.io/f/mgerqzkw" name="contact-us-form" className="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                          <div>
        ...
        <div className="relative -mt-12 max-w-7xl mx-auto pb-16 px-4 sm:pb-24 sm:px-6 lg:px-8">
          <div className="max-w-2xl mx-auto text-center lg:max-w-4xl">
            ...
            <p className="mt-4 text-gray-500">
              The legal world is a confusing place. There are so many lawyers and law firms with different areas of expertise that it's hard to know who you should hire for your case.
            </p>
            <p className="mt-4 text-gray-500">
      ...
      <div className="relative bg-gray-800">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
          <div className="md:ml-auto md:w-1/2 md:pl-10">
            <h2 className="text-base font-semibold uppercase tracking-wider text-gray-300">Ready To Get Started?</h2>
