    ...
    <section className="max-w-8xl mx-auto container pt-16 bg-gray-100">
      ...
      <div className="flex flex-col md:flex-row">
        <div className="flex flex-col justify-center w-full md:w-1/2 px-4 md:pr-12">
          <p className="uppercase text-lg text-gray-600 leading-normal">Residential Real Estate</p>
        ...
        <div className="bg-gray-900 w-full md:w-1/2 px-4 md:px-12 py-10 mt-8 md:mt-0 rounded mr-4">
          <div className="flex pb-10">
            ...
            <div className="mt-1">
              <h4 className="text-lg font-bold leading-tight text-white">Buying a Home</h4>
          ...
          <div className="flex pb-10">
            ...
            <div className="mt-1">
              <h4 className="text-lg font-bold leading-tight text-white">Selling a Home</h4>
          ...
          <div className="flex pb-10">
            ...
            <div className="mt-1">
              <h4 className="text-lg font-bold leading-tight text-white">Residential Mortgage Refinancing</h4>
